...
import { CharactersType, SvgCharacters, TextCharacters } from "./characters";
      ...
      fields: [
        ...
        { 
          ...
          type: {
            ...
            fields: [
              { name: "type", type: { type: "enum", name: "CharactersType", symbols: [CharactersType.TEXT, CharactersType.SVG] } },
